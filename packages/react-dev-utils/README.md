...
var InterpolateHtmlPlugin = require('ambi-react-dev-utils/InterpolateHtmlPlugin');
...
var path = require('path');
var HtmlWebpackPlugin = require('html-webpack-plugin');
var InlineChunkHtmlPlugin = require('ambi-react-dev-utils/InlineChunkHtmlPlugin');
...
```js
var path = require('path');
var ModuleScopePlugin = require('ambi-react-dev-utils/ModuleScopePlugin');
...
```js
var path = require('path');
var WatchMissingNodeModulesPlugin = require('ambi-react-dev-utils/WatchMissingNodeModulesPlugin');
...
```js
var path = require('path');
var checkRequiredFiles = require('ambi-react-dev-utils/checkRequiredFiles');
...
```js
var clearConsole = require('ambi-react-dev-utils/clearConsole');
...
```js
const eslintFormatter = require('ambi-react-dev-utils/eslintFormatter');
...
} = require('ambi-react-dev-utils/FileSizeReporter');
...
var formatWebpackMessages = require('ambi-react-dev-utils/formatWebpackMessages');
...
```
  const printBuildError = require('ambi-react-dev-utils/printBuildError')
  try {
    build()
  } catch(e) {
...
```js
var getProcessForPort = require('ambi-react-dev-utils/getProcessForPort');
...
```js
var path = require('path');
var openBrowser = require('ambi-react-dev-utils/openBrowser');
...
module.exports = {
  ...
  entry: [
    ...
    'ambi-react-dev-utils/webpackHotDevClient',
    'src/index',
  ],
  // ...
};
...
```js
const getCSSModuleLocalIdent = require('ambi-react-dev-utils/getCSSModuleLocalIdent');
...
```js
var getCacheIdentifier = require('ambi-react-dev-utils/getCacheIdentifier');
